...
use app\controllers\Language\Dictionary;
use app\controllers\Language\ExponentGetter;
use app\controllers\Language\ExponentInflector;
use app\controllers\Language\PowerAwareTripletTransformer;
use app\controllers\Language\TripletTransformer;
